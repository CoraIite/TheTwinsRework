...
namespace TheTwinsRework.NPCs.IchorEyes
{
    //[AutoloadBossHead]
    public class GoldCircleLimit : ModNPC
    {
        ...
        public override void Load()
        {
            ...
            TwistTex = ModContent.Request<Texture2D>(AssetDirectory.Assets + "TwistTex");
        }
        ...
        public void DrawBack(Vector2 pos, Color circleColor, Color backColor)
        {
            ...
            Effect shader = ShaderLoader.GetShader("Circle");
        ...
        {
            DrawBack(NPC.Center - Main.screenPosition, Color.Gold, Color.Gold * 0.25f);
